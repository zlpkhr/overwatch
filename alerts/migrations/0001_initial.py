        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Match specific object label (optional)",
                        max_length=100,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.FloatField(
                        default=0.3,
                        help_text="Max cosine distance to trigger alert (lower = stricter)",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="ingest.detectedobject",
                    ),
                ),
                (
                    "frame",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ingest.frame"
                    ),
                ),
                (
                    "rule",
